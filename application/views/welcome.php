                    ...
                    <div class="weekly2-news-active dot-style d-flex dot-style">
                        <div class="weekly2-single">
                            <div class="weekly2-img">
                                <img src="<?= base_url('') ?>assets/img/news/weekly2News1.jpg" alt="">
                            </div>
                        ...
                        <div class="weekly2-single">
                            <div class="weekly2-img">
                                <img src="<?= base_url('') ?>assets/img/news/weekly2News2.jpg" alt="">
                            </div>
                            <div class="weekly2-caption">
                        ...
                        <div class="weekly2-single">
                            <div class="weekly2-img">
                                <img src="<?= base_url('') ?>assets/img/news/weekly2News3.jpg" alt="">
                            </div>
                            <div class="weekly2-caption">
                                <span class="color1">Corporate</span>
                                <p>25 Jan 2020</p>
                        ...
                        <div class="weekly2-single">
                            <div class="weekly2-img">
                                <img src="<?= base_url('') ?>assets/img/news/weekly2News4.jpg" alt="">
                            </div>
                            <div class="weekly2-caption">
